...
class JSBinding {
    ...
    static __wrap(ptr) {
        const obj = Object.create(JSBinding.prototype);
        obj.ptr = ptr;
    ...
    */
    getValue() {
        try {
            ...
            wasm.jsbinding_getValue(retptr, this.ptr);
    ...
    */
    getVar() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jsbinding_getVar(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    */
    toString() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jsbinding_toString(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
...
module.exports.JSBinding = JSBinding;
/**
*/
class JSRSPEngine {

    static __wrap(ptr) {
        const obj = Object.create(JSRSPEngine.prototype);
        obj.ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_jsrspengine_free(ptr);
    }
    /**
    * @param {number} width
    * @param {number} slide
    ...
    * @returns {JSRSPEngine}
    */
    static new(width, slide, rules, abox, query, f) {
        try {
            const ptr0 = passStringToWasm0(rules, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(abox, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len2 = WASM_VECTOR_LEN;
            const ret = wasm.jsrspengine_new(width, slide, ptr0, len0, ptr1, len1, ptr2, len2, addBorrowedObject(f));
            return JSRSPEngine.__wrap(ret);
        } finally {
    ...
    * @param {number} ts
    */
    add(triple_string, ts) {
        const ptr0 = passStringToWasm0(triple_string, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.jsrspengine_add(this.ptr, ptr0, len0, ts);
    }
}
module.exports.JSRSPEngine = JSRSPEngine;
/**
*/
class RoxiReasoner {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_roxireasoner_free(ptr);
    }
    /**
    * @returns {RoxiReasoner}
    */
    static new() {
        const ret = wasm.roxireasoner_new();
    ...
    */
    add_abox(abox) {
        const ptr0 = passStringToWasm0(abox, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.roxireasoner_add_abox(this.ptr, ptr0, len0);
    }
    /**
    * @param {string} rules
    */
    add_rules(rules) {
        const ptr0 = passStringToWasm0(rules, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.roxireasoner_add_rules(this.ptr, ptr0, len0);
    }
    /**
    * @returns {number}
    */
    len_abox() {
        const ret = wasm.roxireasoner_len_abox(this.ptr);
        return ret >>> 0;
    }
    /**
    */
    materialize() {
        wasm.roxireasoner_materialize(this.ptr);
    }
    /**
    * @returns {string}
    */
    get_abox_dump() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.roxireasoner_get_abox_dump(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    */
    query(query) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.roxireasoner_query(this.ptr, ptr0, len0);
...
module.exports.__wbg_debug_37c3d403ef2fe45e = function(arg0, arg1, arg2, arg3) {
    console.debug(getObject(arg0), getObject(arg1), getObject(arg2), getObject(arg3));
};

module.exports.__wbg_error_fef758d6120a6335 = function(arg0) {
    console.error(getObject(arg0));
};

module.exports.__wbg_error_0a9eaa65ad0ac370 = function(arg0, arg1, arg2, arg3) {
    console.error(getObject(arg0), getObject(arg1), getObject(arg2), getObject(arg3));
};

module.exports.__wbg_info_7a618942e19d5ae9 = function(arg0, arg1, arg2, arg3) {
    console.info(getObject(arg0), getObject(arg1), getObject(arg2), getObject(arg3));
};

module.exports.__wbg_log_fc5fef16dc6ffacf = function(arg0, arg1, arg2, arg3) {
    console.log(getObject(arg0), getObject(arg1), getObject(arg2), getObject(arg3));
};

module.exports.__wbg_warn_b524823256513407 = function(arg0, arg1, arg2, arg3) {
...
const path = require('path').join(__dirname, 'roxi_js_bg.wasm');
